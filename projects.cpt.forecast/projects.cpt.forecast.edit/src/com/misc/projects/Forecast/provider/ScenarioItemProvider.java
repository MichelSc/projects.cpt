...
/**
 * This is the item provider adapter for a {@link com.misc.projects.Forecast.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ForecastPackage.Literals.SCENARIO__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ForecastPackage.Literals.SCENARIO__SELECTIONS);
			childrenFeatures.add(ForecastPackage.Literals.SCENARIO__MAPPINGS);
			childrenFeatures.add(ForecastPackage.Literals.SCENARIO__CHILD_SCENARIOS);
			childrenFeatures.add(ForecastPackage.Literals.SCENARIO__MAPPING_RESULTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ForecastPackage.Literals.SCENARIO__SELECTIONS,
				 ForecastFactory.eINSTANCE.createFPOForecastBucketsSelection()));

		newChildDescriptors.add
			(createChildParameter
				(ForecastPackage.Literals.SCENARIO__MAPPINGS,
				 ForecastFactory.eINSTANCE.createForecastMapping()));

		newChildDescriptors.add
			(createChildParameter
				(ForecastPackage.Literals.SCENARIO__CHILD_SCENARIOS,
				 ForecastFactory.eINSTANCE.createScenario()));

		newChildDescriptors.add
			(createChildParameter
				(ForecastPackage.Literals.SCENARIO__MAPPING_RESULTS,
				 ForecastFactory.eINSTANCE.createMappingResult()));
	}

...
import com.misc.common.moplaf.datasetload.provider.LoadCommand;


public class LoadAction extends Action {
		public final static String ID = "com.misc.touse.moplaf.datasetload.LoadActionID";
			...
			if ( part != null  && incomingselection instanceof IStructuredSelection ) {
				...
				if ( structuredselection.size()==1 ) {
					if ( part instanceof IEditingDomainProvider){
						...
						currentCommand = LoadCommand.create(editingDomain, selection);

...
public class PropagatorLayerSortingPlanInputRefreshSelected extends PropagatorFunctionAdapter {
	...
	protected PropagatorFunctionAdapters getAntecedents() {
		...
		PropagatorFunctionAdapter layerSortingPlanSelected = Util.getPropagatorFunctionAdapter(scenario, PropagatorLayerSortingPlanRefreshSelected.class );
		antecedents.add(layerSortingPlanSelected);

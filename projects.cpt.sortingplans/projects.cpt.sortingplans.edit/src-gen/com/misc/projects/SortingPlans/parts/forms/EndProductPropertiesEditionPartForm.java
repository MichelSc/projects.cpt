 ...
 * 
 */
public class EndProductPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EndProductPropertiesEditionPart {
	 ...
	 */
	public EndProductPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public EndProductPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(endProductStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == SortingPlansViewsRepository.EndProduct.Properties.sortingPlanProduct) {
					return createSortingPlanProductFlatComboViewer(parent, widgetFactory);
				}
				if (key == SortingPlansViewsRepository.EndProduct.Properties.whichSortingPlans) {
					return createWhichSortingPlansCheckbox(widgetFactory, parent);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(SortingPlansMessages.EndProductPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createFPDSortingLevelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		fPDSortingLevel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SortingPlansViewsRepository.EndProduct.Properties.fPDSortingLevel, SortingPlansViewsRepository.FORM_KIND));
		...
		fPDSortingLevel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EndProductPropertiesEditionPartForm.this, SortingPlansViewsRepository.EndProduct.Properties.fPDSortingLevel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFPDSortingLevel()));
			}

		});
		fPDSortingLevel.setID(SortingPlansViewsRepository.EndProduct.Properties.fPDSortingLevel);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SortingPlansViewsRepository.EndProduct.Properties.fPDSortingLevel, SortingPlansViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createSortingPlanProductFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		sortingPlanProduct = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SortingPlansViewsRepository.EndProduct.Properties.sortingPlanProduct, SortingPlansViewsRepository.FORM_KIND));
		widgetFactory.adapt(sortingPlanProduct);
		...
		sortingPlanProduct.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EndProductPropertiesEditionPartForm.this, SortingPlansViewsRepository.EndProduct.Properties.sortingPlanProduct, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSortingPlanProduct()));
			}

		});
		sortingPlanProduct.setID(SortingPlansViewsRepository.EndProduct.Properties.sortingPlanProduct);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SortingPlansViewsRepository.EndProduct.Properties.sortingPlanProduct, SortingPlansViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createWhichSortingPlansCheckbox(FormToolkit widgetFactory, Composite parent) {
		whichSortingPlans = widgetFactory.createButton(parent, getDescription(SortingPlansViewsRepository.EndProduct.Properties.whichSortingPlans, SortingPlansMessages.EndProductPropertiesEditionPart_WhichSortingPlansLabel), SWT.CHECK);
		whichSortingPlans.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EndProductPropertiesEditionPartForm.this, SortingPlansViewsRepository.EndProduct.Properties.whichSortingPlans, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(whichSortingPlans.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SortingPlansViewsRepository.EndProduct.Properties.whichSortingPlans, SortingPlansViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createScenarioFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		scenario = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(SortingPlansViewsRepository.EndProduct.Properties.scenario, SortingPlansViewsRepository.FORM_KIND));
		...
		scenario.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EndProductPropertiesEditionPartForm.this, SortingPlansViewsRepository.EndProduct.Properties.scenario, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getScenario()));
			}

		});
		scenario.setID(SortingPlansViewsRepository.EndProduct.Properties.scenario);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(SortingPlansViewsRepository.EndProduct.Properties.scenario, SortingPlansViewsRepository.FORM_KIND), null); //$NON-NLS-1$
